        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="form-inline">
                    <div class="col-sm-8">
                        <span>Range Posts [From - To]:</span>
                        <input type="text" class="form-control" runat="server" id="daterange" name="daterange" value="01/01/2016 - 01/31/2016" />
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server"
                ...
                <ContentTemplate>
                    <div class="row">
                        <div class="col-sm-12">
                            <span class="label label-primary">Group's Posts</span><br />
                            ...
                            <span>Group's Posts: <span class="badge">
